 ...
 */
public class ServicePersistence extends AbstractFilePersistence {
    public ServicePersistence(String name, String root, File outputDir, Logger logger) {
        super(outputDir, name, logger, root + "/META-INF/services/");
    }
